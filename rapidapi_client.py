    ...
    async def get_user_stats(self, username: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            return {
                ...
                "avg_likes_per_tweet": round(total_likes / max(tweets_analyzed, 1), 0),
                "avg_retweets_per_tweet": round(total_retweets / max(tweets_analyzed, 1), 0),
                "avg_replies_per_tweet": round(total_replies / max(tweets_analyzed, 1), 0),
